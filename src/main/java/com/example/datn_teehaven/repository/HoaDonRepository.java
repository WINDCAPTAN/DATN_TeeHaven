...
public interface HoaDonRepository extends JpaRepository<HoaDon, Long> {
    ...
    Integer countHoaDonNgay(@Param("ngayTao") java.util.Date ngayTao);
    ...
    Long sumGiaTriHoaDonNgay(@Param("ngayTao") java.util.Date ngayTao);

    @Query("SELECT COUNT(hd) FROM HoaDon hd WHERE MONTH(hd.ngayTao) = MONTH(:ngayTao) AND (hd.trangThai = 3 or hd.trangThai = 6)")
    Integer countHoaDonThang(@Param("ngayTao") java.util.Date ngayTao);
    ...
    Long sumGiaTriHoaDonThang(@Param("ngayTao") java.util.Date ngayTao);
    ...
    Integer countHoaDonBetween(@Param("startDate") java.util.Date startDate,
                               @Param("endDate") java.util.Date endDate);
    ...
    Long sumGiaTriHoaDonBetween(@Param("startDate") java.util.Date startDate,
                                @Param("endDate") java.util.Date endDate);
    @Transactional
    @Modifying
    ...
    Integer countHoaDonTrangThaiBetween(@Param("startDate") java.util.Date startDate,
                                        @Param("endDate") java.util.Date endDate,
                                        @Param("trangThai") Integer trangThai);

    @Query("SELECT COUNT(hd) FROM HoaDon hd WHERE hd.trangThai = :trangThai and CAST(hd.ngayTao AS DATE) = :ngayTao ")
    Integer countHoaDonTrangThaiNgay(@Param("ngayTao") java.util.Date ngayTao,
                                     @Param("trangThai") Integer trangThai);
